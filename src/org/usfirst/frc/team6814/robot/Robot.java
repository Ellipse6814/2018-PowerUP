...
public class Robot extends TimedRobot {
	...
	public void getArcadeConfig() {
		...
		//Autonomous code if the home switch is on the left and the scale is on the right
		else if((usableArray[0] == 'L' && usableArray[1] == 'R') || (usableArray[0] == 'l' && usableArray[1] == 'r')) {
			
			
		}
		
		//Autonomous code if the home switch is on the right and the scale is on the left 
