...
public class EncoderBackward extends Command{
	...
	protected void initialize() {
		...
		// sets the stopping distance to the distance to be traveled subtracted from the distance traveled since last reset.
